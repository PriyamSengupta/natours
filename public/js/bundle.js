    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            if (res.data.status === 'success') location.reload();else (0, _alert.showAlert)('error', 'Error logging out. Try again later.');
            _context2.next = 10;
            break;
...
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    ...
    scrollZoom: false // center: [-118.349818,34.067985],
    // zoom: 10,
    // interactive: false
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'Success') {
              (0, _alert.showAlert)('success', "".concat(type.toUpperCase(), " updated successfully")); // windows.setTimeout(() => {
              //     location.reload();
              // }, 1500);
            }
